...
public class OldRealisticBiomeTaigaLakes extends RealisticBiomeBase
{
	public OldRealisticBiomeTaigaLakes(int sub) 
	{
		super(sub, RWGBiomes.baseColdForest);
	}
            ...
            else if(b == Blocks.stone)
            {
            	...
            	if(depth == 0)
            	{
            		...
            		else if(k < 63 || (k < 64 && subID == 2))
            		{
            			...
            			{
                			blocks[(y * 16 + x) * 256 + k] = subID == 2 ? Blocks.sand : Blocks.gravel;
            			}
            			gravel = true;
            		}
