...
public class OldRealisticBiomeTundraPlains extends RealisticBiomeBase
{
	public OldRealisticBiomeTundraPlains(int sub)
	{
		super(sub, sub == 0 ? RWGBiomes.baseSnowDesert : RWGBiomes.baseColdPlains);
	}
